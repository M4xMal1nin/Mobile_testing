  ...
  ✅ <a href=""> <strong> Чек-лист </strong> </a> для тестирования 
  функциональности, производительности, удобства использования (usability) и UI
   
  🧪  <a href=""> <strong>Тест-кейсы</strong> </a> созданные в <strong>QASE</strong>,  
  для проверки функциональности, производительности, usability и UI
  
  🐞 <a href=""> <strong>Пример баг-репорта<strong> </a>
